...
export default function AboutSpeech() {
    ...
    return (
        <>
            <div className="mt-12 bg-white max-md:w-[80vw] w-[55vw] h-[55vh] border border-4 rounded-4 p-4 border-[#273b92] bg-gray rounded-xl rounded-br-none text-lg mb-10">
                    
                    <h2 className="pt-5 font-serif text-center text-2xl" >
                        Welcome to UNSW Kpop Society! 
                    </h2>
                    <p className="ml-10 mr-10 pt-11 leading-0.1 text-lg/10 lg:text-2xl/10 font-serif max-md:text-sm">
                    ...
                    <p className="ml-10 text-left pt-[7%] italic lg:text-2xl font-serif">
