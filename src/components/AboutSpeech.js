    ...
    return (
        <>
            <div className="mt-12 bg-white w-[55vw] h-[55vh] border border-4 rounded-4 p-4 border-[#273b92] bg-gray rounded-xl rounded-br-none text-lg mb-10">
                    ...
                    <h2 className="pt-5 font-serif text-center text-xl" >
                        Welcome to UNSW Kpop Society! 
                    </h2>
                    <p className="ml-10 mr-10 pt-11 leading-0.1 text-lg/10 lg:text-xl/10 font-serif">
                    ...
                    <p className="ml-10 text-left pt-[7%] italic lg:text-xl font-serif">
