...
export default function ButtonsMenu() {
    ...
    return (
        <>
            <div className="flex max-md:flex-col max-md:items-center max-md:gap-8 max-md:justify-between max-md:w-auto md:w-screen md:justify-around md:pt-10 md:pb-12"> 
                <Link
                to="/about"
