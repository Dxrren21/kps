                        ...
                        <div className="flex gap-5 max-md:flex-col max-md:align-center">
                            <div className="group relative max-md:w-[250px]  w-[200px] h-[80px] max-md:w-[80%]">
                                <a href="https://forms.gle/5RJ3mJwch4v2Evo57" target="_blank" rel="noopener noreferrer">
                                    <button type="button" className="w-full h-full text-pink-300 border-gray-500 border border-2 hover:border-purple-500 font-semibold rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">
                            ...
                            <div className="group relative max-md:w-[250px]  w-[200px] h-[80px] max-md:w-[80%]">
                                <a href="https://forms.gle/5RJ3mJwch4v2Evo57" target="_blank" rel="noopener noreferrer">
                                    <button type="button" className="w-full h-full text-blue-300 border-gray-500 border border-2 hover:border-purple-500 font-semibold rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">
                                    <span className="text-lg">
                                        Arc Form
                                    </span>
