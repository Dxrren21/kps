    ...
    return (
        <section className="grid gap-10 pt-20 grid-cols-1 max-md:flex max-md:flex-col max-md:items-center">  
            ...
            <div className="group relative w-full max-md:w-[80%]">
                <div className="flex justify-center items-center text-center max-md:w-full max-md:p-5 max-md:text-sm bg-white w-[100%] h-[200px] max-md:h-[120px] rounded text-xl text-gray-700 font-medium border-2 border-gray-400 hover:border-[#273b92] font-semibold tracking-wider hover:text-[1.3rem] hover:border-2">
