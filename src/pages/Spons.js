            ...
            <section className="w-full min-h-screen flex flex-col items-center bg-sponbg bg-cover bg-center">
                <div className="flex items-center gap-2 pb-10 pt-10">
                    <img src={star} className="w-10 h-10 pt-1 "></img>
                        <h1 className="text-5xl text-center font-extrabold uppercase">K-Perks</h1>
                    <img src={star} className="w-10 h-10 pt-1  "></img>
                </div>
                <h3 className="margin-x-auto text-2xl text-gray-700 italic">See what deals and opportunities society members get from our amazing 2025 sponsors!</h3>
                ...
                <div className="flex items-center gap-2 pt-10">
                    <img src={star} className="w-10 h-10 pt-1 "></img>
                        <h1 className="text-5xl text-center font-extrabold uppercase">O-Week Specials</h1>
                    <img src={star} className="w-10 h-10 pt-1  "></img>
                </div>
                <SponsorMarquee />
                <div className="flex items-center gap-2 pt-10">
                    <img src={star} className="w-10 h-10 pt-1 "></img>
                        <h1 className="text-5xl text-center font-extrabold uppercase">Year Round Deals</h1>
                    <img src={star} className="w-10 h-10 pt-1  "></img>
                </div>
                <OWeekMarquee />
            </section>
